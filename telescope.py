...
#
# Author:   Arto Oksanen <artooksanen@gmail.com> (aok)
#
# -----------------------------------------------------------------------------
# Edit History:
#   Generated by Python Interface Generator for AlpycaDevice
#
# 29-Jan-2025   aok Initial edit
...
class TelescopeMetadata:
    ...
    Name = 'Rihlapera'
    Version = '1.0'
    Description = 'Rihlapera Telescope'
    DeviceType = 'Telescope'
    DeviceID = '28cfaa5f-206a-44f3-85a8-b0755889a487' # https://guidgenerator.com/online-guid-generator.aspx
    Info = 'Rihlapera Alpaca Telescope Driver\nImplements ITelescope\nASCOM Initiative'
    MaxDeviceNumber = maxdev
    InterfaceVersion = 1        # ITelescopeVxxx
...
class connect:
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
          ...
          print("PUT connect out: DevConnected:",DevConnected,"clients:",connected_clients)
          # ------------------------
...
class connected:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        global DevConnected
        global connected_clients
        print("telescope.connected: PUT")
        conn_str = get_request_field('Connected', req)
        conn = to_bool(conn_str)              # Raises 400 Bad Request if str to bool fails
        print("PUT connected in: ",conn,"DevConnected:",DevConnected,"clients:",connected_clients)
        try:
            # --------------------------------------
            if(conn):
             if connected_clients>0:
               ...
               connected_clients=1
               DevConnected = True ### CONNECT OR DISCONNECT THE DEVICE ###
               print("telescope.connected: rade.connect() ->")
               rade.connect()
               print("telescope.connected: rade.connect() <-")
            else:
...
class abortslew:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            rade.abortslew() ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
...
class azimuth:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = rade.get_azimuth() ## GET PROPERTY ##
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class declination:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = rade.get_de() ## GET PROPERTY ## Vega
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class rightascension:
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = rade.get_ra() ## GET PROPERTY ## Vega
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class siderealtime:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = rade.get_siderealtime() ## GET PROPERTY ##
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class sitelatitude:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            SiteLatitude=sitelatitude ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
...
class sitelongitude:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = SiteLongitude ## GET PROPERTY ##
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            SiteLongitude = sitelongitude ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
...
class slewing:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = rade.is_slewing() ## GET PROPERTY ##
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
...
class slewtocoordinates:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            rade.slew(rightascension,declination) ### DEVICE OPERATION(PARAM) ###
            #DevSlewing=True
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
...
class slewtotarget:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            rade.slew(TargetRightascension,TargetDeclination) ### DEVICE OPERATION(PARAM) ###
            #DevSlewing=False
            ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
...
class synctocoordinates:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            rade.set_ra(rightascension)
            rade.set_de(declination)
            ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
...
class synctotarget:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            ### DEVICE OPERATION(PARAM) ###
            rade.set_ra(TargetRightascension)
            rade.set_de(TargetDeclination)
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
...
class targetdeclination:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = TargetDeclination ## GET PROPERTY ##
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            TargetDeclination = targetdecliation ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
...
class targetrightascension:
    ...
    def on_get(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # ----------------------
            val = TargetRightascension ## GET PROPERTY ##
            # ----------------------
            resp.text = PropertyResponse(val, req).json
        except Exception as ex:
            resp.text = PropertyResponse(None, req,
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            TargetRightascension=targetrightascension ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
...
class tracking:
    ...
    def on_put(self, req: Request, resp: Response, devnum: int):
        ...
        try:
            # -----------------------------
            DevTracking=tracking ### DEVICE OPERATION(PARAM) ###
            # -----------------------------
            resp.text = MethodResponse(req).json
        except Exception as ex:
            resp.text = MethodResponse(req,
